...
import { LayoutGrid, Database as DbIcon, Bot, BadgeDollarSign, Search, Cloud, BookText } from 'lucide-react';
...
const tabs = [
  ...
  { id: 'content', label: 'المذكرات والفيديو', icon: FileText },
  { id: 'articles', label: 'الشروحات والمقالات', icon: BookText },
