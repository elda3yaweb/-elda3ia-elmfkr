...
export const defaultSettings: PlatformSettings = {
  ...
  subSlogan: 'منصة المسابقات الدعوية والمعرفية',
  logoUrl: '/logo.png',
  ...
  instructionsTitle: 'تعليمات المنصة',
  instructions: [
    'سجّل بياناتك كاملة وصحيحة لضمان استلام الشهادة.',
    'الاسم يجب أن يكون رباعياً ومطابقاً للهوية الرسمية.',
    'لديك عدد محاولات محدد لكل اختبار، استغلها جيداً.',
    'يُمنع فتح الحساب من أكثر من جهاز واحد.',
    'وقت كل اختبار محدد، انتبه للعداد الزمني.',
    'في حال وجود أي مشكلة تواصل مع إدارة المنصة عبر واتساب.',
  ],
  ...
  seoTitle: 'الداعية المفكر — منصة المسابقات الدعوية والمعرفية',
  seoDescription:
    'منصة الداعية المفكر: مسابقات دعوية ومعرفية، اختبارات تفاعلية، شهادات معتمدة، ولوحة شرف للمتميزين. سجّل الآن وابدأ رحلة العلم والتنافس.',
  seoKeywords: 'مسابقات إسلامية, السيرة النبوية, علوم القرآن, اختبارات دينية, الداعية المفكر, شهادات',
  seoImage: '/logo.png',
  seoAuthor: 'منصة الداعية المفكر',
...
export const defaultComments: CommentItem[] = [
  { id: 'cm1', name: 'أحمد محمد', text: 'منصة رائعة جزاكم الله خيراً، استفدت كثيراً!', date: new Date().toLocaleString('ar-EG'), approved: true },
  { id: 'cm2', name: 'فاطمة سعيد', text: 'الأسئلة مميزة والتصميم جميل جداً ما شاء الله.', date: new Date().toLocaleString('ar-EG'), approved: true },
];
